...
class Alltest():
    ...
    def __init__(self):
        ...
        self.OS = readConfigLocal.getConfigValue("platformName")
        self.caseList = []
    ...
    def get_casePath(self):
        ...
        casePath = os.path.join(readConfig.prjDir, "testSet", "cases", "Android")

        if self.OS == "iOS":

            casePath = os.path.join(readConfig.prjDir, "testSet", "cases", "iOS")
    ...
    def create_suite(self):
        ...
        if len(self.caseList) > 0:
            ...
            for case_name in self.caseList:
                ...
                discover = unittest.defaultTestLoader.discover(self.get_casePath(), pattern=case_name+'.py', top_level_dir=None)
